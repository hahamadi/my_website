...
<head>
    <title>Poltek Nuklir - Signup</title>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('regrister') }}" class="signup" method="POST">
                                @csrf
                                <div class="input-group mb-2">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" name="admin_role" class="form-control" placeholder="Role" required>
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                    ...
                    <div class="col-md-6 d-none d-md-block">
                        <img src="https://drive.google.com/uc?id=1h3XnUXMP27Urlt44vScAMBEQvyxBXOOI" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
