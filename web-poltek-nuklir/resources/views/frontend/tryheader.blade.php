...
<nav class="navbar navbar-custom navbar-fixed-top navbar-transparent" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <div class="row-img-logo-poltek">
                <div class="column-img-logo-poltek">
                    <img src="assets/images/logo_poltek/Logo BRIN_portrait (1).png" alt="logo-brin">
                </div>
                <div class="column-img-logo-poltek">
                <img src="assets/images/logo_poltek/POLTEK NUKLIR 4.png" alt="logo-poltek-nuklir">
                </div>
            </div>
            <!--
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse">
                <span class="sr-only">Poltek Nuklir</span>
                <span class="icon-bar"></span>
                <span class="icon-bar"></span>
                <span class="icon-bar"></span>
            </button>
            <a class="navbar-brand" href="index.html">Poltek Nuklir</a>
            -->
          </div>
